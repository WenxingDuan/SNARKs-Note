...
% \input{macro}
% \todo{
%     1. The new main file is snark_note. The old one is not deleted.
%     2. Think about the structure of the notes.
%     3. Fix the false and ambiguous statements in the notes.
% }
