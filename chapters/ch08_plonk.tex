...
HyperPlonk-style systems replace the univariate subgroup domain by the Boolean hypercube $\set{0,1}^t$ and replace univariate ZeroTests by multilinear SumCheck protocols. The motivation is to reduce prover time by avoiding some expensive univariate quotient computations.
...
\begin{itemize}[leftmargin=2em]
    ...
    \item \textbf{Plonk + IPA PCS} gives transparency but slower verification \cite{Bulletproofs2018}.
