...
%% ============================================================
\subsection{The Ali Baba's Cave}
%% ============================================================
...
%% ============================================================
\subsubsection{Exercise: The Apple Test}
%% ============================================================
...
%% ============================================================
\subsection{Sigma Protocols for Discrete Logarithm}
%% ============================================================
...
\todo{it may be more clear here to use chaum pedersen to have a better definition of soundness here. But special soundness capture that the prover must knows the witness because the definition say he must be able to prove for two challenge, which is iff he knows the witness.}
...
%% -----------------------------------------------------------
\subsubsection{First Attempt: Reveal the Witness Directly}
%% -----------------------------------------------------------
...
%% -----------------------------------------------------------
\subsubsection{Second Attempt: Blind the Response with a Nonce}%
...
%% -----------------------------------------------------------
\subsubsection{Third Attempt: Incorporate the Witness into the Response}
%% -----------------------------------------------------------
...
%% -----------------------------------------------------------
\subsubsection{Fourth Attempt: A Binary Challenge}
%% -----------------------------------------------------------
...
%% -----------------------------------------------------------
\subsubsection{The Schnorr Protocol: Large Challenge Space}
%% -----------------------------------------------------------
...
%% ============================================================
\subsection{Why Can Proofs Be Zero-Knowledge?}
%% ============================================================

\todo{I think this part is not super correct. Obviously knowledge soundness and zero knowledge cannot coexist. But soundness is related to whether the statement is in $L$ or not, not related to whether you know the witness.}
% 我的疑问是单纯的soundness似乎并不关系你知不知道witness,而是关心能否证明一个错误命题,但是ZKP的定义里关心的是你是否拥有这个witness,两者无法构成矛盾。soundness是关于statement的,而knowledge soundness是关于witness的。soundness似乎不关心你有没有witness,假设我知道这个graph是Hamiltonian的,但我没有witness,我该怎么prove呢}

% \todo{同时实现statistical soundness和statistical zero knowledge的protocol只存在于L = AM intersect coAM, 然后NP不属于这个class}
\todo{there seems to have no soundness definition in sigma protocol. I should check the literature.}
\todo{it also seems like for 3-coloring and hamiltonian graph, if the prover doesn't know the witness, he cannot commit to a valid statement. 
So maybe the problem here is that the DL problem is not a decision problem, which makes the soundness weird.}
...
\subsubsection{The Scope of Zero-Knowledge Proofs}
...
%% ============================================================
\subsection{From Interactive to Non-Interactive: The Role of the CRS}
%% ============================================================

\subsubsection{The problem with NIZK}
...
\subsubsection{The common reference string}
