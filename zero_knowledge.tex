...
\begin{exercisebox}
  Formally prove all three properties for the Schnorr protocol. For honest-verifier ZK, write down the explicit simulator and show the simulated and real distributions over $(a, c, z)$ are identical.
\end{exercisebox}
