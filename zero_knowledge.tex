...
\todo{rephrase this part}Before moving to the non-interactive world it is worth pausing on a basic incompatibility.
...
%% ============================================================
\section{The Scope of Zero-Knowledge Proofs}
%% ============================================================
\todo{also add the intro example, also i want to add some exercise abotu suduko}The Schnorr protocol proves one thing about one specific algebraic structure. A natural question is how broadly zero knowledge applies: is it a niche property of a handful of number-theoretic problems, or does it scale?
