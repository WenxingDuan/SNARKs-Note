...
\]
The example is intentionally color coded. The colors are a reading device for tracking how one object is represented in the next layer. This is the arithmetization route underlying QAP-based systems such as GGPR, Pinocchio, and Groth16~\cite{GennaroGentryParnoRaykova2013,ParnoHowellGentryRaykova2013,Groth2016}. We stop at the QAP divisibility relation and do not construct a Groth16 proof.
