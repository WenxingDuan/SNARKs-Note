...
%% ---- Pairing group notation ----
%% \GT  : the target group G_T
%% \gone{a}, \gtwo{a}, \gT{a} : bracket encoding [a]_1, [a]_2, [a]_T
...
%  \propboxsound{completeness}{honest-verifier ZK}{soundness}  (no "special")
...
%  Inline TODO note (visible in PDF)
\newcommand{\todo}[1]{%
  \begin{tcolorbox}[
    enhanced,
...
%  Exercise box (orange)
%  Usage: \begin{exercisebox} ... \end{exercisebox}
%  The bold "Exercise." label is added automatically.
